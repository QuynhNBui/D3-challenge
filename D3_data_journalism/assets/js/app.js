...
function updateToolTip(chosenXAxis, chosenYAxis, circlesGroup) {
    ...
    var toolTip = d3.tip()
        ...
        .offset([-8, 0])
        .html(function(d) {
            return (`<strong>${d.state}</strong><hr color = "white">${xLabel} ${styleX(d[chosenXAxis], chosenXAxis)}<br>${yLabel} ${d[chosenYAxis]}%`);
        });
...
d3.csv("./assets/data/data.csv").then(function(censusData) {
    ...
    var mainXTitle = chartGroup.append("text")
                            .attr("transform", `translate(${width-70}, ${height-5})`)
                            .classed("axis-main-text", true)
                            .text("Demographics")
    ...
    var mainYTitle = chartGroup.append("text")
                            .attr("transform", `translate(15,110)rotate(270)`)
                            .classed("axis-main-text", true)
                            .text("Behavioral Factors")
